...
void mouse_callback(GLFWwindow *window_, double xpos_, double ypos_);
void scroll_callback(GLFWwindow* window_, double xoffset_, double yoffset_);

const unsigned int SCR_WIDTH = 800;
const unsigned int SCR_HEIGHT = 600;

const std::string filepath = "/Users/liwenlong/github/Learn_Opengl/code/hello_window/hello_window/camera_mouse_zoom/";
...
int main() {
    ...
    Shader ourShader((filepath + "camera.vs").c_str(), (filepath + "camera.fs").c_str());
    ...
    // world space position of our cubes
