...
const std::string filepath = "/Users/liwenlong/github/Learn_Opengl/code/hello_window/hello_window/transformations/";
...
int main() {
    ...
    Shader ourShader((filepath + "texture.vs").c_str(), (filepath + "texture.fs").c_str());
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        transform1 = glm::scale(transform1, glm::vec3(abs(sin(glfwGetTime())), abs(sin(glfwGetTime())), 1.0f));
