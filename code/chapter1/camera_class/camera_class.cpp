...
const std::string filepath = "/Users/liwenlong/github/Learn_Opengl/code/hello_window/hello_window/camera_class/";

void framebuffer_size_callback(GLFWwindow *window_, int width_, int height_);
void processInput(GLFWwindow *window_);
void scroll_callback(GLFWwindow *window_, double xpos_, double ypos_);
void mouse_callback(GLFWwindow *window_, double xoffset_, double yoffset_);
